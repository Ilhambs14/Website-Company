...
<?php include 'navbar.php'; ?>
    ...
    <div id="home" class="h-[300px] bg-gray-100 bg-gradient-to-t from-[#cffdfc] via-white to-white flex items-center">
        <div class="container mx-auto px-4 ml-10">
            ...
            <h1 class="text-4xl lg:text-5xl font-bold text-[#00A19B]">Kontak</h1>
            <p class="mt-5 text-xs lg:text-base text-[#00A19B]">
                Kami akan dengan senang hati membantu Anda dalam masalah apa pun
                <br> dan memberikan saran profesional mengenai layanan kami. </p>
        </div>
    </div>
    </div>
    </div>
    ...
    <div class="max-w-screen-lg mx-auto p-5 shadow-lg mt-20 mb-20">
        <div class="grid grid-cols-1 md:grid-cols-12">
            <div class="bg-[#00A19B] md:col-span-4 p-10 text-white rounded-md">
                <h3 class="text-2xl md:text-3xl lg:text:4xl leading-normal font-extrabold tracking-tight">
                    Kontak Informasi
                </h3>
                <p class="mt-4 leading-7 text-gray-200">
                    Para ahli kami akan memandu Anda melalui pilihan AC terbaik dan menjelaskan perbedaan antar-produk. </p>
                ...
                <div class="flex items-center mt-5">
                    ...
                    <span class="text-xs ml-3">Komp. Lotus Garden Blok AA No.11.</span>
                </div>
                <div class="flex items-center mt-5">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="28" height="28" fill="rgba(255,255,255,1)">
                    ...
                    <span class="text-xs ml-3">( 0778 )- 462.881</span>
                </div>
                <div class="flex items-center mt-5">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="28" height="28" fill="rgba(255,255,255,1)">
                        <path d="M3 3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3ZM20 7.23792L12.0718 14.338L4 7.21594V19H20V7.23792ZM4.51146 5L12.0619 11.662L19.501 5H4.51146Z"></path>
                    </svg>
                    <span class="text-xs ml-3">pt.becool.indonesia@gmail.com</span>
                </div>

            </div>


            <form action="aksi/add_contact.php" method="post" class="md:col-span-8 p-10">
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <input
                            ...
                            id="grid-email" type="text" name="nama" required placeholder="Nama...">
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <input
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-email" type="text" name="no_telp" required placeholder="No Telpon...">
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <input
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-email" type="email" name="email" required placeholder="Alamat Email...">
                    </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <textarea rows="10"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="Masukan Pesan Anda" id="pesan" name="pesan" rows="5" required></textarea>
                    </div>
                    <div class="flex justify-between w-full px-3">
                        <div class="md:flex md:items-center">
                            <label class="block text-gray-500 font-bold">
                                ...
                                <span class="text-sm">
                                    Kirimkan saya buletin Anda!
                                </span>
                            </label>
                        </div>
                        <button
                            class="shadow bg-[#00A19B] hover:bg-[#BAE3E2] focus:shadow-outline focus:outline-none text-white font-bold py-2 px-6 rounded"
                            type="submit">
                            Kirim Pesan
                        </button>
                    </div>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap justify-between">
                <div class="w-full md:w-1/3 mb-6 md:mb-0">
                    ...
                    <p class="text-gray-400 text-xs mt-5">Jujur dalam bekerja, cepat dan tanggap menerima dan melayani komplain ,kepuasan
                ...
                <div class="w-full md:w-1/3">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="https://www.instagram.com" target="_blank" class="text-gray-400  transition duration-300">
